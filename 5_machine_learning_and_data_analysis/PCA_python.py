...
data = pd.read_csv('data/14_25.csv', header=None, sep=';', decimal=',').values.astype(float)
...
print("Задание 1\n")
# вывод результатов
print(f"Координата первого объекта по первой главной компоненте: {x1:.5f}")
print(f"Координата первого объекта по второй главной компоненте: {y1:.5f}")
print(
